...
//#define MULTI_CLASS_DEVICE	// Support for multiple classes, added as per main.c
...
#define EP_2_LEN 64		// Assume IN and OUT are the same length
#define EP_2_OUT_LEN EP_2_LEN
#define EP_2_IN_LEN EP_2_LEN

#define EP_UARTINTERFACE_NUM 2	// Helper for some functions & readability
#define EP_UARTINTERFACE_NUM_LEN EP_2_LEN
...
#elif __PIC32MM__
	/* PIC32MM don't know, try PPB_ALL */
	#define PPB_MODE PPB_ALL
#else
...
/* Comment the following line to use polling USB operation. When using polling,
   ...
   application. */
//#define USB_USE_INTERRUPTS	// Also defined in Makefile
